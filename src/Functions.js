...
export const girisKontrol = () => {
    ...
    const div = ReactDOM.createRoot(document.getElementById("div"));
...
export const logout = () => {
    ...
    document.getElementById("user_name_div").style.display = "inline-block";
    document.getElementById("btnGiris").innerHTML = "";
